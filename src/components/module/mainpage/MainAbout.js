      ...
      <div className="container md:max-w-screen-xl md:h-screen flex flex-col md:flex-row">
        <div className=" relative w-screen md:w-[50%] h-full">
          ...
          <div className="md:w-full md:h-full grid  w-full grid-cols-12 grid-rows-[10vh_30vh_20vh_30vh_10vh] px-5">
            <div className="col-start-6 col-end-13 row-start-2 row-end-4 rounded-3xl overflow-hidden border-4 border-textWhite">
              <Image
            ...
            <div className="z-[-1] col-start-1 col-end-8 row-start-3 row-end-5 rounded-3xl overflow-hidden border-4 border-textWhite">
              <Image
                className="object-cover h-full w-full"
        ...
        <div className="w-screen md:w-[50%] h-full px-5 md:py-[15vh] ">
          ...
          <h4 className=" text-[2rem] md:text-[3rem] mt-[30px]">
            پیشگام در آینده زندگی هوشمند
          </h4>
          <p  className="mt-[20px] text-textGray text-[14px]">
          ...
          <div className="w-full flex justify-around mt-8">
            <div className="flex flex-col items-center w-fit">
              <span className="text-[2rem]">50</span>
              <span>پروژهای تمام شده</span>
            </div>
            <div className="flex flex-col items-center w-fit">
              <span className="text-[2rem]">50</span>
              <span>پروزهای در حال بررسی</span>
            </div>
          </div>
          <Link href="/about" className="text-textWhite bg-secondery inline-block px-10 py-4 rounded-full mt-10">ادامه مطلب</Link>
        </div>
      </div>
    </div>
  );
